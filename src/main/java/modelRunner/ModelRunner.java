...
public class ModelRunner extends AbstractModelRunner{
	...
	//========================  EU =======================
		...
		protected String anualDemandFile = "C:\\data\\CRAFTY data set\\data_EUpaper_nocsv\\worlds\\EU\\regionalisations\\28\\RCP2_6-SSP1\\RCP2_6-SSP1_demands_EU.csv";// - zero bio.csv";
	//====================================================	
